/**
 * Copyright (c) 2013-2015 http://www.kanq.com.cn/
 *
...
/**
 * <p>
 * Title:取得系统当前日期、当前时间、当前年、当前月、当前季度、格式化日期处理
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Company:KQ GEO Technologies Co., Ltd.
 * </p>
 * 
 * @author KQ GEO Technologies Co., Ltd.
 * @version 1.0
 */
...
public class DateUtils {
	...
	public static final String FM_DEFAULT_DATE_PATTERN = "yyyy-MM-dd";

	public static final String FM_DATE_AND_TIME = "yyyy-MM-dd HH:mm:ss";

	public static final String FM_DATE_AND_TIME_SF = "yyyy-MM-dd HH:mm";
	...
	public static String fotmatDateTOyMdHms(Date myDate) {
		...
		return new SimpleDateFormat(FM_DATE_AND_TIME).format(myDate);
	}
	 ...
	 * ************ Extend ***********
	 */
	public static Timestamp toCalendarDate(String date, String time) {
		if ((date != null) && (date.length() >= 9) && (time != null)
			...
			Timestamp d = new Timestamp(cal.getTime()
					.getTime());
	...
	public static Date parse(String strDate) throws ParseException {
		return StringHelpers.isNull(strDate) ? null : parse(strDate,
				getDatePattern());
	}
	...
	public static Date parse(String strDate, String pattern)
		...
		return StringHelpers.isNull(strDate) ? null : new SimpleDateFormat(
	 ...
	 * @return
	 */
	public static String getStrtoLon(String user_time) {
		String re_time = null;
		SimpleDateFormat sdf = new SimpleDateFormat(FM_DATE_AND_TIME);
		Date d;
		try {
	 ...
	 * @return
	 */
	public static String getLontoStr(String cc_time) {
	...
	public static String getDistanceTime(String str1, String str2) {
		DateFormat df = new SimpleDateFormat(FM_DATE_AND_TIME);
		Date one;
		Date two;
		long day = 0;
		long hour = 0;
	...
	public static void main(String[] args) {
		...
		System.out.println(DateUtils.DateFormat("yyyy-MM-dd", "2018-02-02"));
		System.out.println(getNowDate());
		System.out
		.println("---------"+DateUtils.format(DateUtils.addDay(getNowDate(), -1)));
		System.out
				.println(DateUtils.format(DateUtils.addDay(getNowDate(), 20)));
		System.out.println("------------------");
		System.out
				.println(DateUtils.format(DateUtils.addYear(getNowDate(), 10)));
		System.out.println(DateUtils.getDistanceTime(getNowDate(), DateUtils.addDay(getNowDate(), 10)));
		System.out.println("------------------");
		String dateFormat = DateUtils.DateFormat("2016-01-01")+"";
		System.out.println(dateFormat);
		String replace = dateFormat.replace(dateFormat.substring(11, 19), "00:00:00");
		System.out.println(new Date(replace));
		System.out.println("------------------------------");
		DateUtils.DateFormat(DateUtils.FM_DATE_AND_TIME, "");
		System.out.println("+++++++++++++++++++++++++++++++++++++++++");
		System.out.println(DateUtils.getDistanceTime(getNowDate(), DateUtils.addDay(getNowDate(), 10)));
		try {
			System.out.println(DateUtils.format(DateUtils.addDay(DateUtils.parse("2011-02-28"), 1)));
		} catch (ParseException e) {
